...
namespace Logic
{
    public class StatusBusiness
    {
        ...
        public List<StatusModel> ConvertToStatus(List<MonitoringDataModel> monitoringDataModels)//werkt
        {
            ...
            statuses.Add(CreatestatusModel(startTime, monitoringDataModels[monitoringDataModels.Count-1].TimeStamp, status, entries, (monitoringDataModels[monitoringDataModels.Count - 1].TimeStamp - startTime).TotalSeconds));//final status
